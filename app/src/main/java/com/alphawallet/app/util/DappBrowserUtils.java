...
public class DappBrowserUtils {
    ...
    private static final String DEFAULT_HOMEPAGE = "https://motoran.net/browser/";
    private static final String POLYGON_HOMEPAGE = "https://motoran.net/browser-item-category/polygon/";
